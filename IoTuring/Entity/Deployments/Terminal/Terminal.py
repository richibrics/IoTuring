...
class Terminal(Entity):
    ...
    def Callback(self, message):
        ...
        self.last_output = command.stdout or f"Error: {command.stderr}"
    ...
    def Update(self):
        ...
        if self.has_binary_state or self.has_state:
            ...
            last_output = command.stdout or f"Error: {command.stderr}"
            self.SetEntitySensorExtraAttribute(
                KEY_STATE, "Last state command output", last_output)
